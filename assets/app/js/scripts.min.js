...
$(function() {
    ...
    $('.main-head').parallax({
        imageSrc: 'assets/app/img/123.jpg'
    });
    $('.bg-lights').parallax({
        imageSrc: 'assets/app/img/bg-img2.jpg'
    });
    $('.s-portfolio').parallax({
        imageSrc: 'assets/app/img/port21.jpg'
    });
    $('.s-profile').parallax({
        imageSrc: 'assets/app/img/profile21.jpg'
    });
    $('.s-whywe').parallax({
        imageSrc: 'assets/app/img/w1.jpg'
    });
    $('.s-content').parallax({
        imageSrc: 'assets/app/img/bg-header.jpg'
    });
...
$(window).on('load', function() {
    ...
    $(".animation_4 h1").animated("fadeInDown", "fadeOutUp");
    $(".animation_4 p").animated("fadeInUp", "fadeOutDown");
    $(".animation_1").animated("fadeInLeft", "fadeOutDown");
    $(".animation_2").animated("fadeInRight", "fadeOutDown");
